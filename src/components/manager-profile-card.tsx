...
export function ManagerProfileCard({ user, profile, className, ...props }: ManagerProfileCardProps) {
    ...
    return (
        <Card className={cn("flex flex-col", className)} {...props}>
            ...
            <CardContent className="flex-grow flex flex-col justify-center space-y-4">
                ...
                <DetailRow icon={Shield} label="Teams Managed" value={profile.teams.length} />
