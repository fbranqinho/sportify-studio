...
import { ChevronLeft, Trash2, UserPlus, Users, Search, X, ShieldCheck, Goal, Square } from "lucide-react";
    ...
    <div className="space-y-6">
       <Card>
          <CardHeader>
             ...
             <CardDescription>Motto: &quot;{team.motto}&quot; | City: {team.city}</CardDescription>
          </CardHeader>
       </Card>
